    ...
    public function getUserContext(User $user): array
    {
        ...
        return [
            ...
            'organization' => $organization ? [
                ...
                'currency' => $currency,
                'business_activity' => $organization->business_activity?->value ?? 'retail',
                'business_activity_label' => $organization->business_activity?->label() ?? 'Commerce de détail',
                'is_service_organization' => is_service_organization($organization),
                'can_sell_products' => can_sell_products($organization),
                'can_sell_services' => can_sell_services($organization),
                'has_stock_management' => has_stock_management($organization),
                'labels' => [
                    'product' => product_label(false, true, $organization),
                    'products' => product_label(true, true, $organization),
                    'product_type' => product_type_label(false, $organization),
                    'product_types' => product_type_label(true, $organization),
                    'inventory_section' => inventory_section_label($organization),
                ],
            ] : null,
